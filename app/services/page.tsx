...
const SERVICES = [
  {
    ...
    bullets: ["Promise of Natal Chart", "SWOT Analysis of your horoscope"]
  },
  {
    id: "career-finances",
    ...
    bullets: ["Career planning", "Financial decisions"]
  },
  {
    id: "relationships",
    ...
    bullets: ["Relationship challenges", "Marital harmony"]
  },
  {
    id: "matchmaking",
    title: "Matchmaking",
    ...
    bullets: ["Ashtakoot Guna Milan and beyond", "Mangalik Dosha and yoga"]
  },
  {
    id: "education",
    ...
    bullets: ["Favourable subjects", "Success timeline"]
  },
  {
    id: "varshaphal",
    ...
    bullets: ["Annual forecast", "Promises and challenges"]
  },
  {
    id: "muhurta",
    ...
    bullets: ["Marriage muhurta", "Property purchase and housewarming"]
  },
  {
    id: "other",
    ...
    bullets: ["Targeted problem solving", "Targeted remedies"]
  }
];
